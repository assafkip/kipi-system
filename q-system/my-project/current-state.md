...
Productized version of the kipi-core investigation memory layer, for boutique intel / small T&S teams. Lives in `~/projects/intel/projects/kipi-investigations/`.
