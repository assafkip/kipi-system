...
Read `~/.config/kipi/founder-profile.md`. If it contains `{{SETUP_NEEDED}}`, this is a fresh install. Tell the user: "This is a fresh Q Founder OS install. Let's get you set up — I'll ask a few questions, one topic at a time."
